		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="row">
				...
				<table class="table table-bordered table-striped display wrap" width="100%">
					...
					?>
						<h6 style="font-family: 'SF Sports Night NS', sans-serif; font-size: 15px; text-align: right;">Consumidor Final</h6>
					<?php
					}
					?>
				...
				?>
					<h4>Total a Pagar: <b>$<?php echo $totalPresupuesto; ?></b></h4>
				<?php
				}
				?>
