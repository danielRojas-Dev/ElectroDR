...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <form method="POST"
                style='background-color:#D4E6F1;border-radius: 0.50rem;padding-top: 15px; padding-left:15px; padding-right:15px; padding-bottom:15px;'
                action="guardarProductos.php" enctype="multipart/form-data">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" autofocus class="form-control" id="nombre_producto" name="nombre_producto"
                            required>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-12">
                        <label class="control-label modal-label" for="img_produc">Elija una imagen para el
                            Producto:</label>
                    </div>
                    <div class="col-sm-12">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" autofocus class="form-control" id="precio_produc" name="precio_produc"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="marca" name="marca">
                        ...
                        <option value="<?php echo $rowMarca['id_marca'] ?>"><?php echo $rowMarca['descrip_marca']; ?>
                        </option>
                        <?php endwhile; ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="negocio" name="negocio">
                        ...
                        <option value="<?php echo $rowNegocio['id_negocio'] ?>">
                            <?php echo $rowNegocio['descrip_negocio']; ?></option>
                        <?php endwhile ?>
                    </select>
                </div>
