            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item" href="../mod_presupuestos/index.php">Realizar Presupuesto</a>
                      <a class="dropdown-item" href="../mod_historial_clientes/index.php">Historial Presupuesto</a>
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item"  href="../mod_productos/index.php">Agregar Produtos</a>
                      <a class="dropdown-item" href="../mod_negocios/index.php">Negocios</a>
                      <a class="dropdown-item" href="../mod_marcas/index.php">Marcas</a>
